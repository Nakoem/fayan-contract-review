...
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,600;0,700&family=DM+Sans:opsz,wght@9..40,400;9..40,500&display=swap');

:root { --navy: #1a1f36; --gold: #c9a96e; --cream: #faf8f5; --border: #e0d8c8; --ink: #2c2416; }

.main-title { font-family: 'Cormorant Garamond', 'Noto Serif SC', serif !important; font-size: 2rem !important; font-weight: 700 !important; color: var(--navy) !important; }
...
st.caption("基于法规库 + 判例库 + 地方政策 + 税务规则四重知识库的 AI 法律助手")
...
with st.sidebar:
    ...
    st.divider()
    st.caption("© 2026 法眼 · Qwen-Plus + RAG")
